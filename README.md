...
```python
# Change to the "Selector" event loop if plattform is windows
if sys.platform.lower() == "win32" or os.name.lower() == "nt":
    # only import if plattform/os is win32/nt, otherwise "WindowsSelectorEventLoopPolicy" is not present
    from asyncio import (
