...
- Make socket connection asynchronous (@empicano in #399)
- Close socket cleanly on unexpected first packet (@empicano in #399)
- Name asyncio background tasks (@empicano in #400)
- Refactor `subscribe` to accept one or more `TopicFilter` objects sent as single SUBSCRIBE packet
- Refactor `unsubscribe` to accept one or more patterns sent as single UNSUBSCRIBE packet
