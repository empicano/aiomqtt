...
- Add Flow Control options to the Client-Constructor. Contributed by [Andreas Heine (@andreasheine)](https://github.com/andreasheine) in [#179](https://github.com/sbtinstruments/asyncio-mqtt/pull/179)
